					...
					<ul class="top-link">
						<%
							if(session.getAttribute("customer")!=null){
												out.print("<li class='dropdown'><a href='#' class='dropdown-toggle' data-toggle='dropdown'><span class='glyphicon glyphicon-user'></span>"+ 
							((Customer) request.getSession().getAttribute("customer")).getCallName() + 
							"</a><div class='dropdown-menu' style='center'><div class='dropdown-inner'><ul class='list-unstyled'><li><input type='button' id='quit' value='quit' ></li></ul></div></div></li>");
							} else {
								out.print("<li><a href='account.jsp'><span class='glyphicon glyphicon-user'></span>My Account</a></li>");
							}
						%>
						<li><a href="myinfomation.jsp"><span class="glyphicon glyphicon-envelope"></span> 个人信息</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<!--					<li><a href="category.jsp">Software</a></li>-->
	...
	<div id="page-content" class="home-page">
		<div class="container">
				...
				<div class="col-lg-12">
					...
					<div class="products">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="ProductDetailServlet?ProductID=1"><img src="phoneimg/01/C5/Cgbj0Vl4NtSAIhhgAA5gODMkEVQ102.png@240x240.jpg" /></a></div>
								<div class="buttons">
								...
								<div class="caption">
									<div class="name"><h3><a href="ProductDetailServlet?ProductID=1">魅族 PRO 7</a></h3></div>
									<div class="price">￥2880<span>￥4880</span></div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="ProductDetailServlet?ProductID=4"><img src="phoneimg/00/C6/Cix_s1hGE9KAJ1E-AAv78Kz1Hok651.png@240x240.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="ProductDetailServlet?ProductID=4">魅蓝 Note 5</a></h3></div>
									<div class="price">￥899<span>￥980</span></div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
								<div class="image"><a href="ProductDetailServlet?ProductID=7"><img src="phoneimg/00/2C/Cgbj0VkAUNiAQhISAAla6NENI0Q072.png@240x240.jpg" /></a></div>
								<div class="buttons">
									<a class="btn cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a>
									<a class="btn wishlist" href="#"><span class="glyphicon glyphicon-heart"></span></a>
									<a class="btn compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a>
								...
								<div class="caption">
									<div class="name"><h3><a href="ProductDetailServlet?ProductID=7">魅蓝 E2</a></h3></div>
									<div class="price">￥1299<span>$2098</span></div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading"><h2>热销</h2></div>
					<div class="products">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="product">
